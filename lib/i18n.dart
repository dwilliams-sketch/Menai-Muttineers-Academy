...
const Map<String, String> _pirate = {
  ...
  'Temporary Academy videos are removed 30 days after an assessment is reviewed or a Help Me conversation is resolved, unless you mark them to keep.':
      'Temporary videos go overboard 30 days after review or resolution unless the Captain marks them to keep.',
  // V1.4.2 learner video uploads
  'That video is too large. Please choose a shorter clip under 100 MB.':
      'That moving picture is too heavy for the ship! Choose a shorter clip under 100 MB.',
  'We could not upload that video. Please try again or use a video link instead.':
      'We could not haul that video aboard. Try again or use a video link instead.',
  ...
  'Send us a short video showing the skill. The easiest option is to record one now or choose one already on your phone.':
      'Send the crew a short video showing the skill. Record one now or choose one already on your phone.',
  ...
  'Keep clips short and clear. Recordings are limited to 90 seconds and Academy uploads have a 100 MB maximum.':
      'Keep clips short and clear, matey — 90 seconds maximum and no more than 100 MB.',
  'Tell the trainers what is happening. You can also send us a short video so we can see exactly what you mean.':
      'Tell the trainers what is going wrong, and send a short video if it helps us see the trouble.',
  ...
  'Download the video and save it somewhere permanent first. You can paste the Drive or folder link below if you want.':
      'Take a copy ashore and stow it somewhere safe first. Add the treasure-map link below if ye have one.',
  ...
  'Official training tools stay locked while this dog is paused. Restart the adventure or use the 1-to-1 button on the anchored screen.':
      'Training gear stays below deck while this dog is anchored. Set sail again or use the 1-to-1 button on the anchored screen.',
  ...
  'Payments happen outside the app. The Academy does not collect your bank or card details.':
      'Payments happen ashore. The Academy never stores your bank or card details.',
  ...
  'Photo upload is currently disabled by Admin. This keeps the Academy on the low-cost setup until cloud photo storage is enabled.':
      'Portrait uploads are currently below deck. This keeps the Academy running on the low-cost setup until cloud storage is enabled.',
  'Photo upload is not available yet. Admin may need to enable Firebase Storage.':
      'Portrait upload is not ready yet. The quartermaster may need to enable cloud storage.',
...
const Map<String, String> _cy = {
  ...
  'Assessment could not be completed. Your video is still here — please try again.':
      'Ni ellid cwblhau’r asesiad. Mae eich fideo dal yma — rhowch gynnig arall arni.',
  'DELETE VIDEO NOW': 'DILEU’R FIDEO NAWR',
  'REVIEWED': 'WEDI’I ADOLYGU',
  'The video exists, but the Academy could not obtain access to it.':
      'Mae’r fideo yn bodoli, ond ni allai’r Academi gael mynediad ato.',
  'The Academy could not obtain access to this video.':
      'Ni allai’r Academi gael mynediad at y fideo hwn.',
  'The original video could not be opened.':
      'Ni ellid agor y fideo gwreiddiol.',
  'Message sent.': 'Neges wedi’i hanfon.',
  'Message could not be sent. Please try again.':
      'Ni ellid anfon y neges. Rhowch gynnig arall arni.',
  'Training could not be saved. Please try again.':
      'Ni ellid cadw’r hyfforddiant. Rhowch gynnig arall arni.',
  '✅ Payment confirmed successfully.':
      '✅ Taliad wedi’i gadarnhau’n llwyddiannus.',
  'Payment could not be confirmed. Nothing has been added twice.':
      'Ni ellid cadarnhau’r taliad. Nid oes dim wedi’i ychwanegu ddwywaith.',
  'WATCH LIST ONLY': 'RHESTR WYLIO YN UNIG',
  'Doubloon balance: ': 'Balans Doubloons: ',
  'Access until: ': 'Mynediad tan: ',
  'ON STAFF WATCH LIST': 'AR RESTR WYLIO’R STAFF',
  'Tap to view treasure history': 'Tapiwch i weld hanes y trysorau',
  'No trophies earned yet.': 'Dim tlysau wedi’u hennill eto.',
  'Tap to view training history': 'Tapiwch i weld hanes hyfforddi',
  'No training diary entries yet.': 'Dim cofnodion dyddiadur hyfforddi eto.',
  'Private Captain/Admin ideas, jobs and follow-ups.':
      'Syniadau, tasgau a chamau dilynol preifat y Capten/Gweinyddwr.',
  'Captain’s Log item added.': 'Eitem wedi’i hychwanegu at Log y Capten.',
  'OPEN': 'AGORED',
  'There is no Academy video file to delete.':
      'Nid oes ffeil fideo Academi i’w dileu.',
  'Delete this video now?': 'Dileu’r fideo hwn nawr?',
  'Use this for a wrong, duplicate or private upload. ':
      'Defnyddiwch hwn ar gyfer uwchlwythiad anghywir, dyblyg neu breifat. ',
  'DELETE VIDEO': 'DILEU FIDEO',
  'Video deleted. The assessment record has been kept.':
      'Fideo wedi’i ddileu. Mae cofnod yr asesiad wedi’i gadw.',
  'The video could not be deleted. Nothing was removed from the assessment record.':
      'Ni ellid dileu’r fideo. Ni chafodd dim ei dynnu o gofnod yr asesiad.',
  'Academy video deleted — assessment record retained.':
      'Fideo’r Academi wedi’i ddileu — cofnod yr asesiad wedi’i gadw.',
  'SHOW RECENT': 'DANGOS Y DIWEDDARAF',
  'VIEW ALL TRAINING HISTORY': 'GWELD HOLL HANES HYFFORDDI',
  'Storage refresh failed. Technical details are shown below.':
      'Methodd adnewyddu’r storfa. Mae’r manylion technegol isod.',
  'Please translate or type the Welsh title and message before publishing.':
      'Cyfieithwch neu deipiwch deitl a neges Gymraeg cyn cyhoeddi.',
  '✅ Notice published successfully in English and Welsh.':
      '✅ Hysbysiad wedi’i gyhoeddi’n llwyddiannus yn Gymraeg ac yn Saesneg.',
  'Notice could not be published. Nothing was lost — please try again.':
      'Ni ellid cyhoeddi’r hysbysiad. Ni chollwyd dim — rhowch gynnig arall arni.',
  'PUBLISHING...': 'YN CYHOEDDI...',
  'Published Notices': 'Hysbysiadau Cyhoeddedig',
  'These are the notices currently visible to Academy users.':
      'Dyma’r hysbysiadau sydd i’w gweld ar hyn o bryd gan ddefnyddwyr yr Academi.',
  'No published notices are currently active.':
      'Nid oes hysbysiadau cyhoeddedig gweithredol ar hyn o bryd.',
  'Notice removed from the Academy.': 'Hysbysiad wedi’i dynnu o’r Academi.',
  ...
  'Temporary Academy videos are removed 30 days after an assessment is reviewed or a Help Me conversation is resolved, unless you mark them to keep.':
      'Caiff fideos dros dro yr Academi eu dileu 30 diwrnod ar ôl i asesiad gael ei adolygu neu sgwrs Help Me gael ei datrys, oni bai eich bod yn eu marcio i’w cadw.',
  // V1.4.2 learner video uploads
  'That video is too large. Please choose a shorter clip under 100 MB.':
      'Mae’r fideo hwnnw’n rhy fawr. Dewiswch glip byrrach o dan 100 MB.',
  'We could not upload that video. Please try again or use a video link instead.':
      'Ni allem uwchlwytho’r fideo hwnnw. Rhowch gynnig arall arni neu defnyddiwch ddolen fideo yn lle.',
  'We could not remove that video. Please try again.':
      'Ni allem dynnu’r fideo hwnnw. Rhowch gynnig arall arni.',
  'Please record a video, choose one from your phone, or add a video link.':
      'Recordiwch fideo, dewiswch un o’ch ffôn, neu ychwanegwch ddolen fideo.',
  'Send us a short video showing the skill. The easiest option is to record one now or choose one already on your phone.':
      'Anfonwch fideo byr atom yn dangos y sgil. Y ffordd hawsaf yw recordio un nawr neu ddewis un sydd eisoes ar eich ffôn.',
  ...
  'Keep clips short and clear. Recordings are limited to 90 seconds and Academy uploads have a 100 MB maximum.':
      'Cadwch y clipiau’n fyr ac yn glir. Mae recordiadau wedi’u cyfyngu i 90 eiliad ac mae uchafswm o 100 MB ar uwchlwythiadau’r Academi.',
  'Tell the trainers what is happening. You can also send us a short video so we can see exactly what you mean.':
  ...
  'Download the video and save it somewhere permanent first. You can paste the Drive or folder link below if you want.':
      'Lawrlwythwch y fideo a’i gadw mewn lle parhaol yn gyntaf. Gallwch ludo dolen Drive neu ffolder isod os dymunwch.',
