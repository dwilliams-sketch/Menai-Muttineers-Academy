...
String tr(String input, {String? languageCode}) {
  ...
  final patterns = <MapEntry<RegExp, String Function(Match)>>[
    MapEntry(RegExp(r'^Welcome aboard, (.+)$'), (m) => 'Croeso aboard, ${m.group(1)}'),
...
const Map<String, String> _cy = {
  ...
  'Welcome back aboard.': 'Croeso yn ôl aboard.',
  'Email': 'E-bost',
  ...
  'Welcome aboard — we’ll set you up in three simple steps.': 'Croeso aboard — byddwn yn eich sefydlu mewn tri cham syml.',
  'Your name': 'Eich enw',
  ...
  'What needs attention, who needs help, and what is happening aboard.': 'Beth sydd angen sylw, pwy sydd angen help, a beth sy’n digwydd aboard.',
  'Learners': 'Dysgwyr',
  ...
  'Automatic translation is not ready yet. Deploy the V1.3 Firebase Functions and enable Cloud Translation, or type the Welsh version manually.': 'Nid yw cyfieithu awtomatig yn barod eto. Defnyddiwch Firebase Functions V1.3 a galluogwch Cloud Translation, neu teipiwch y fersiwn Gymraeg â llaw.',
  ...
  'In-app notifications work on the normal setup. True background push and Firebase photo storage use optional Firebase services described in the V1.3 setup guide.': 'Mae hysbysiadau yn yr ap yn gweithio gyda’r gosodiad arferol. Mae gwthio cefndir a storio lluniau Firebase yn defnyddio gwasanaethau dewisol a ddisgrifir yng nghanllaw gosod V1.3.',
  ...
  'Legacy dog moved onto a fresh V1.3 Academy voyage.': 'Ci etifeddol wedi’i symud i fordaith Academi V1.3 newydd.',
  ...
  'SET SAIL ON A NEW ADVENTURE': 'HWYLIO AR ANTUR NEWYDD',
  'START V1.3 ACCESS': 'DECHRAU MYNEDIAD V1.3',
  ...
  'The deletion service is not ready yet. Set up V1.3 Firebase Functions using the included guide, then try again.': 'Nid yw’r gwasanaeth dileu yn barod eto. Sefydlwch Firebase Functions V1.3 gan ddefnyddio’r canllaw, yna rhowch gynnig arall.',
